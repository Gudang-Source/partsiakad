                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="info-bea-kmhs.html">
                                <i class="fa fa-edit"></i> Informasi Beasiswa</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> Tambah Beasiswa
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" placeholder="persyaratan"></textarea>
                             </div>

                             <div class="form-group">
                                <label>Tanggal Awal Pendaftaran</label>
                                <input type="date" class="form-control" placeholder="Nama Beasiswa">
                             </div>
