                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                           <li><a href="info-bea-kmhs.php">Informasi Beasiswa</a></li>
                                            <li><a href="verifikasi-pend.php">Pengaju Beasiswa</a></li>
                                            <li><a href="verifikasi-hasil-seleksi.php">Hasil Seleksi</a></li>
                                        </ul>
                                    </li>
                                </ul>
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="penerima-kmhs.html">
                                <i class="fa fa-edit"></i> Pengaju Beasiswa</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> Verifikasi Pendaftaran
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-info"><i class="glyphicon glyphicon-ok"></i>
  Validasi</button>
                                            </td>
                                        </tr>
                                    </tbody>
