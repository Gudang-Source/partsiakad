				...
				<li class=""><a href="">Dashboard</a></li>
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo URL; ?>matkulreguler">KRS Reguler</a></li>
							<li><a href="#">KRS SP</a></li>
							<li><a href="#">Pembatalan KRS</a></li>
							<li><a href="#">Transkrip</a></li>
							<li><a href="#">Hasil Studi</a></li>
							<li><a href="#">Perkuliahan</a></li>
							<li><a href="#">Jadwal Kuliah</a></li>
							<li><a href="#">Pengajuan Matkul SP</a></li>
                            <li><a href="<?php echo URL; ?>ta/tamhs">Tugas Akhir</a></li>
						</ul>
				</li>
				<li class="dropdown">
						...
						<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo URL; ?>cuti/cutimhs">Pengajuan Cuti Kuliah</a></li>
						</ul>
				</li>
			</ul>
