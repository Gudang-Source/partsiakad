                                ...
                                <ul class="nav navbar-nav">
									...
									<li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="info-bea-kmhs.html">Status Kuliah</a></li>
                                            <li><a href="pindah-kmhs.php">Pengajuan Pindah Kuliah</a></li>
                                            <li><a href="pengunduran-kmhs.php">Pengajuan Pengunduran Diri</a></li>
											<li><a href="pendaftar-kmhs.html"></a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="#">Surat Keputusan Yudisium</a></li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <!-- Page Heading -->
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i><a href="#">Cuti Kuliah</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i>Pengaju Cuti Kuliah
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>132410101067</td>
                                        <td>Faizal Prastiyono</td>
										<td>
                                            <button class="btn btn-primary">Detail Alasan</button>
                                        </td>
                                        <td>
