<div class="container  form-control" style="height:585px" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <i class="fa fa-edit"></i>Pembimbing Tugas Akhir
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <?php
            echo "<td>";
            echo "<form action =\"" . URL . "ta/getDataPembimbing/\"  method = \"get\">";
            echo "<select name=\"pembimbing\" style=\" width: 50%;font-size:small\">";
            if ($this->pembimbing != " ") {
                echo "<option>" . $this->pembimbing . "</option >";
            }
            ...
            if ($this->pembimbing != " ") {
                foreach ($this->talist as $key => $value) {
                    ...
                    echo "<td class=\"text-center\"><a href=\"" . URL . "ta/cetaktugaspembimbing/" . $value['pembimbing'] . "\" class=\"btn btn-success btn-md\"><span class=\"glyphicon glyphicon-print\"></span></td>";
                }
            }
            ?>
            </tbody>
