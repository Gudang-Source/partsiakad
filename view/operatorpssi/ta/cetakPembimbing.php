...
// menulis header
        $this->Cell(30, 10, 'SURAT TUGAS BIMBINGAN TUGAS AKHIR', 0, 0, 'L');
...
$pdf->SetFont('Times', '', 12);
    $pdf->MultiCell(0, 5, "
    Surat ini merupakan surat tugas untuk membimbing mahasiswa yang telah menempuh mata kuliah tugas akhir
    Program Studi Sistem Informasi.
    kami tugaskan bimbingan ini kepada :

    NIP                     :	" . $data[0]['pembimbing'] . "
    Nama Dosen       :	" . $data[0]['namaLengkap'] . "

    berikut ini adalah data mahasiswa yang akan dibimbing :
    NIM                           :	" . $data[0]['nim'] . "
