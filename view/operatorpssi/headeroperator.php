                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo URL; ?>ta/operator_tamhs"">Tugas Akhir</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo URL; ?>ta/operator_pembimbing"">Pembimbing Tugas Akhir</a></li>
                                            <li><a href="<?php echo URL; ?>ta/operator_penguji"">Penguji Tugas Akhir</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown">
