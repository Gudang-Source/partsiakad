...
<head>
    <title>SIAKAD</title>
    <link rel="shortcut icon" href="<?php echo URL ?>img/logounej.png"/>
    <!-- Latest compiled and minified CSS -->
    <link rel="stylesheet" href="<?php echo URL; ?>public/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo URL; ?>public/css/siakad.css">
    <link rel="stylesheet" href="<?php echo URL; ?>public/css/Niceajahgan.css">
    <!-- Script jquery -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="mainNavbar" >
                        <ul class="nav navbar-nav">
                            <li class="<?php echo URL;?>dashboard"><a href="<?php echo URL;?>dashboard">Dashboard</a></li>
                            <li class="<?php echo URL;?>dashboard"><a href="<?php echo URL;?>ta/judulta">Mahasiswa</a></li>
                            <li class="dropdown">
                                <a href="" class="dropdown-toggle active" data-toggle="dropdown">Dosen
                                    <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo URL?>ta/view_dosenpembimbing">Dosen Pembimbing</a></li>
                                    <li><a href="<?php echo URL ?>ta/view_dosenpenguji">Dosen Penguji</a></li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="" class="dropdown-toggle active" data-toggle="dropdown"> <span class="glyphicon glyphicon-user"></span> <?php echo session::get('nama');?>
                                    <span class="caret"></span></a>
                                <ul class="dropdown-menu">
